...
public class MenuKontrol : MonoBehaviour
{
   ...
   */
    ...
    string komut;
    int i = 0, seciliRegisterNumarasi, seciliRegisterNumarasi2, bellek, islem, tglDurum, seciliBellekNo,yontem;
            ...
            case 7:
                switch (islem)
                {
                    case 0:
                        ...
                        {
                            txKontrol.text = inputfieldlar[seciliBellekNo].GetComponent<InputField>().text;
            ...
            case 9:
                ...
                { 
                    ...
                    case 0:
                        if (tglDurum == 1)
                        {
                            GameObject temp = GameObject.FindGameObjectWithTag(ozelRegisterlar1[seciliRegisterNumarasi2].GetComponent<InputField>().text);
                        ...
                        {
                            GameObject temp = GameObject.FindGameObjectWithTag(inputfieldlar[1+seciliBellekNo].GetComponent<InputField>().text);
                        ...
                        {
                            GameObject temp = GameObject.FindGameObjectWithTag(ozelRegisterlar1[seciliRegisterNumarasi2].GetComponent<InputField>().text);
                            txIslemler.text += seciliBellek + " adresine " + seciliRegister2 + "'de tutulan bellek adresinin " + temp.GetComponent<InputField>().text + " değeri taşındı\n";
                            inputfieldlar[seciliBellekNo + 1].GetComponent<InputField>().text = temp.GetComponent<InputField>().text;
                            txKontrol.text = inputfieldlar[seciliBellekNo + 1].GetComponent<InputField>().text;
                            inputfieldlar[seciliBellekNo + 1].GetComponentsInChildren<Text>()[1].color = Color.red;
                        }
                        break;
    ...
    public void AnimOynat()
    {
        ...
        else
        {
            ...
            {
                anim.SetBool("bellek", false);
                Debug.Log("bellek anim false oldu");
            }
        }
    }
